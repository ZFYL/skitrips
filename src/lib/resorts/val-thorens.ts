// Val Thorens, France — the reference resort. Copy this file's shape to add a
// new resort (see resorts/types.ts for the schema; resorts/shared.ts for
// reusable options like US_INSURANCE).
    ...
    options: [
      {
        ...
        allInclusive: ['skipass', 'rental', 'skischool'],
...
export const valThorens: Resort = {
  ...
  area: 'Les 3 Vall\u00e9es',
  blurb:
    'Highest resort in Europe at 2,300 m and the gateway to the 600 km Les 3 Vall\u00e9es \u2014 the biggest linked ski area on Earth.',
  lat: 45.2975,
  lon: 6.5795,
  elevationM: 2300,
  currency: 'EUR',
  gatewayAirports: ['GVA', 'LYS', 'CMF'],
  defaultOrigin: 'JFK',
  mapsName: 'Val Thorens',
  saturdayChangeover: true,
  season: { open: '2026-11-21', close: '2027-05-02', linkOpen: '2026-12-05', linkClose: '2027-04-17' },
  weeks: alpineWeeks,
  snowByMonth: VT_SNOW,
  snowFacts:
